...
public class GameSettings {
    ...
    public static float[] PROTECT_BUFF = {0, 0.03f, 0.05f, 0.07f, 0.09f, 0.12f}; // вероятность 0-1.0 (не включительно)
    public static float[] CRITICAL_BUFF = {0, 0.05f, 0.07f, 0.9f, 0.11f, 0.13f}; // вероятность 0-1.0  (не включительно)
